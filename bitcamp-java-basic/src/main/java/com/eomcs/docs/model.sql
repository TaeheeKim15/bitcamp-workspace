...
CREATE TABLE lms_stud (
  ...
  elno  INTEGER     NOT NULL COMMENT '학력 변호', -- 학력 변호
  schno INTEGER     NOT NULL COMMENT '학교 번호', -- 학교 번호
  majno INTEGER     NOT NULL COMMENT '전공 번호', -- 전공 번호
  banno INTEGER     NULL     COMMENT '은행 번호', -- 은행 번호
...
CREATE TABLE lms_mgr (
  ...
  pno INTEGER     NOT NULL COMMENT '직급 번호', -- 직급 번호
  dno INTEGER     NOT NULL COMMENT '부서 번호', -- 부서 번호
...
CREATE TABLE lms_lect (
  ...
  rno     INTEGER      NULL     COMMENT '교실 번호', -- 교실 번호
...
CREATE TABLE lms_room (
  rno   INTEGER     NOT NULL COMMENT '교실 번호', -- 교실 번호
  cenno INTEGER     NOT NULL COMMENT '지점 번호', -- 지점 번호
...
ALTER TABLE lms_room
  MODIFY COLUMN rno INTEGER NOT NULL AUTO_INCREMENT COMMENT '교실 번호';

-- 수강신청
CREATE TABLE lms_appl (
  ano  INTEGER  NOT NULL COMMENT '수강신청 번호', -- 수강신청 번호
  sno  INTEGER  NOT NULL COMMENT '학생 번호', -- 학생 번호
  lno  INTEGER  NOT NULL COMMENT '교육과정 번호', -- 교육과정 번호
...
ALTER TABLE lms_appl
  MODIFY COLUMN ano INTEGER NOT NULL AUTO_INCREMENT COMMENT '수강신청 번호';
...
ALTER TABLE lms_edu_level
  MODIFY COLUMN elno INTEGER NOT NULL AUTO_INCREMENT COMMENT '학력 변호';
...
ALTER TABLE lms_school
  MODIFY COLUMN schno INTEGER NOT NULL AUTO_INCREMENT COMMENT '학교 번호';
...
ALTER TABLE lms_major
  MODIFY COLUMN majno INTEGER NOT NULL AUTO_INCREMENT COMMENT '전공 번호';
...
ALTER TABLE lms_center
  MODIFY COLUMN cenno INTEGER NOT NULL AUTO_INCREMENT COMMENT '지점 번호';

-- 은행
CREATE TABLE lms_bank (
  banno INTEGER     NOT NULL COMMENT '은행 번호', -- 은행 번호
...
ALTER TABLE lms_bank
  MODIFY COLUMN banno INTEGER NOT NULL AUTO_INCREMENT COMMENT '은행 번호';
...
ALTER TABLE lms_posi
  MODIFY COLUMN pno INTEGER NOT NULL AUTO_INCREMENT COMMENT '직급 번호';
...
ALTER TABLE lms_dept
  MODIFY COLUMN dno INTEGER NOT NULL AUTO_INCREMENT COMMENT '부서 번호';
