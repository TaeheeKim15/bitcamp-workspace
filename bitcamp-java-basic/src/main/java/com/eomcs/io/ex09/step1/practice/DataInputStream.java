...
package com.eomcs.io.ex09.step1.practice;
...
public class DataInputStream extends InputStream {
	...
	public String readUTF() throws Exception {
		...
		연결부품.read(bytes); // 배열 개수 만큼 바이트를 읽어 배열에 저장한다.
