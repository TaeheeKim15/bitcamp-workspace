...
public class Exam0110 {
	...
	public static void main(String[] args) throws Exception {
		...
		// 결국 별도의 클래스를 생성하여 기존코드를 복사해 와야 한다
		// - 결국 코드가 중복되는 문제 발생
		// - 또 상황따라 다양한 조합 수행하다보면
		// 중복 코드를 갖는 클래스가 많이 생성된다
		// - 이 또한 유지보수를 어렵게 하는 요인이다

		// 해결책
		// - 확장 기능을 장식품처럼 붙였다 뗐다할 수 있게 만들자
		// 레고처럼!
		// 모든 블록은 붙이는 부분이 같은 유형으로 되어 있다.
		// 그래ㅓㅅ 다른 블록에 마음대로 붙였다 뗄 수 있다.
