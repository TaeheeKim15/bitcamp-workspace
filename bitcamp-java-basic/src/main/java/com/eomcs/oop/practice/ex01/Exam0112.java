...
public class Exam0112 {
	public static void main(String[] args) {
		// 여러 개의 변수(메모리)를 묶어서 한 사람의 성적 정보를 저장하는 상황
		// => 밥 국  반찬1 반찬2 반찬3을 쟁반에 담아서 가져오자

		// 1) 클래스 문법으로 성적 데이터를 저장할 메모리 구조 설계
		// 클래스
		// - 다양한 타입의 메모리를 묶어 새로운 형태의 메모리 설계하는 문법
		// - 개발자가 새롭게 정의한 데이터 타입
		// - 그래서 "사용자 정의 데이터 타입"이라고 부른다
		// [문법]
		// 
		//		 class 새_데이터_타입_이름 {
		//		  변수 선언;
